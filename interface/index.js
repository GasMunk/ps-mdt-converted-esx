...
$(document).ready(() => {
    ...
    $(".profile-items").on("click", ".profile-item", function () {
        let id = $(this).data("id");
        $.post('https://mdt/getProfileData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".bulletin-items-continer").on("keydown", ".bulletin-item", function (e) {
        if (e.keyCode === 13) {
            ...
            let time = new Date()
            $.post('https://mdt/newBulletin', JSON.stringify({
                title: title,
                info: info,
                time: time.getTime()
            }));
    ...
    $(".contextmenu").on("click", ".remove-bulletin", function () {
        ...
        $.post('https://mdt/deleteBulletin', JSON.stringify({
            id: BulletinId,
            time: time.getTime()
        }));
    ...
    $('#gallery-upload-input').keydown(function (e) {
        if (e.keyCode === 13) {
            ...
            if (URL !== "") {
                ...
                $('.gallery-inner-container').prepend(`<img src="${URL}" class="gallery-img ${randomNum}" onerror="this.src='https://cdn-icons-png.flaticon.com/512/2748/2748558.png'">`);
                setTimeout(() => {
                    URL = $("." + randomNum).attr("src")
                    $.post('https://mdt/addGalleryImg', JSON.stringify({
                        cid: cid,
                        URL: URL
                    }));
                }, 250);
        ...
        if (canSaveProfile == true) {
            ...
            setTimeout(() => {
                ...
                if (newpfp.includes("base64")) {
                    newpfp = "https://cdn-icons-png.flaticon.com/512/2748/2748558.png"
                } else {
                    pfp = newpfp
                }
                ...
                $.post('https://mdt/saveProfile', JSON.stringify({
                    pfp: pfp,
    ...
    $(".manage-incidents-title-holder").on("click", ".manage-incidents-save", function () {
        if (canSaveProfile == true) {
            ...
            $.post('https://mdt/saveIncident', JSON.stringify({
                ID: dbid,
                title: title,
            ...
            setTimeout(() => {
                if (canRefreshIncidents == true) {
                    ...
                    setTimeout(() => {
                        ...
                        $.post('https://mdt/getAllIncidents', JSON.stringify({}));
                    }, 1500);
                }
            }, 1000);
    ...
    $(".manage-incidents-title-holder").on("click", ".manage-incidents-create", function () {
        if ($(".badge-logo").attr('src') == 'https://w7.pngwing.com/pngs/160/152/png-transparent-star-of-life-emergency-medical-services-symbol-ambulance-miscellaneous-angle-logo-thumbnail.png') {
    ...
    $(".contextmenu").on("click", ".search-vehicle", function () {
       ...
       setTimeout(() => {
           ...
           setTimeout(() => {
               ...
               $.post('https://mdt/searchVehicles', JSON.stringify({
                   name: plate.toString()
               }));
               $(".dmv-items").empty();
                $('.dmv-items').prepend(`<div class="profile-loader"></div>`);
               setTimeout(() => {
                   $.post('https://mdt/getVehicleData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".search-weapon", function () {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                $.post('https://mdt/searchWeapon', JSON.stringify({
                    name: plate.toString()
                }));
                $(".weapons-items").empty();
                $('.weapons-items').prepend(`<div class="profile-loader"></div>`);
                setTimeout(() => {
                    $.post('https://mdt/getWeaponData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".revoke-licence", function () {
        $.post('https://mdt/updateLicence', JSON.stringify({
    ...
    $('#profile-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://mdt/searchProfiles', JSON.stringify({
                    name: name
                }));
                $(".profile-items").empty();
    ...
    $('#incidents-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (incident !== "") {
                canSearchForProfiles = false
                $.post('https://mdt/searchIncidents', JSON.stringify({
                    incident: incident
                }));
    ...
    $('#dispatchmsg').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            e.preventDefault()
            const time = new Date()
            $.post('https://mdt/dispatchMessage', JSON.stringify({
                message: $(this).val(),
                time: time.getTime()
            }));
            $(this).val("")
    ...
    $(".incidents-items").on("click", ".incidents-item", function () {
        ...
        $.post('https://mdt/getIncidentData', JSON.stringify({
            id: id
        }));
    })
    ...
    document.onkeyup = function (data) {
        if (data.which == 27) {
            ...
            if (shouldClose == true) {
                $.post('https://mdt/escape', JSON.stringify({}));
            }
        }
    };
    ...
    $(".icidents-person-search-name-input").on("keydown", "", function (e) {
        if (e.keyCode === 13) {
            ...
            $.post('https://mdt/incidentSearchPerson', JSON.stringify({
                name: name
            }));
        }
    });
    ...
    $('#incidents-upload-input').keydown(function (e) {
        if (e.keyCode === 13) {
            ...
            if (URL !== "") {
                let randomNum = Math.ceil(Math.random() * 10).toString()
                $('.manage-incidents-evidence-holder').prepend(`<img src="${URL}" class="incidents-img ${randomNum}" onerror="this.src='https://cdn-icons-png.flaticon.com/512/2748/2748558.png'">`);
    ...
    $(".manage-bolos-title-holder").on("click", ".manage-bolos-save", function () {
        ...
        $.post('https://mdt/newBolo', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            plate: plate,
    ...
    $('#bolos-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (searchVal !== "") {
                canSearchForProfiles = false
                $.post('https://mdt/searchBolos', JSON.stringify({
                    searchVal: searchVal
                }));
                $(".bolos-items").empty();
    ...
    $(".bolos-search-refresh").click(function () {
        if (canRefreshBolo == true) {
            ...
            setTimeout(() => {
                ...
                canRefreshBolo = true
                $.post('https://mdt/getAllBolos', JSON.stringify({}));
            }, 1500);
        }
    });
    ...
    $('#bolo-gallery-upload-input').keydown(function (e) {
        if (e.keyCode === 13) {
            ...
            if (URL !== "") {
                let randomNum = Math.ceil(Math.random() * 10).toString()
                $('.bolo-gallery-inner-container').prepend(`<img src="${URL}" class="bolo-img ${randomNum}" onerror="this.src='https://cdn-icons-png.flaticon.com/512/2748/2748558.png'">`);
    ...
    $(".bolos-items").on("click", ".bolo-item", function () {
        ...
        canInputBoloOfficerTag = true
        let id = $(this).data("id");
        $.post('https://mdt/getBoloData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".contextmenu").on("click", ".bolo-delete", function () { 
        ...
        if ($(this).data("info") != 0) {
            if ($(".badge-logo").attr('src') == 'https://w7.pngwing.com/pngs/160/152/png-transparent-star-of-life-emergency-medical-services-symbol-ambulance-miscellaneous-angle-logo-thumbnail.png') {
                ...
                $.post('https://mdt/deleteICU', JSON.stringify({
                id: $(this).data("info")
            }));
        }
        $(".bolos-items").find("[data-id='" + $(this).data("info") + "']").remove();
        $.post('https://mdt/deleteBolo', JSON.stringify({
            id: $(this).data("info"),
    ...
    $(".contextmenu").on("click", ".incident-delete", function () { 
        ...
        $.post('https://mdt/deleteIncident', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".missing-delete", function () { 
        ...
        $.post('https://mdt/deleteMissing', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".profile-missing", function () { 
        $.post('https://mdt/missingCitizen', JSON.stringify({
            cid: $(this).data("info"),
    ...
    $(".contextmenu").on("click", ".add-charge", function () { 
        ...
        $.post('https://mdt/getPenalCode', JSON.stringify({}));
    });
    ...
    $(".contextmenu").on("click", ".associated-incidents-remove-tag", function () { 
        ...
        if (incidentId != 0) {
            $.post('https://mdt/removeIncidentCriminal', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".incidents-remove-normal-tag", function () { 
        ...
        let cid = $(".manage-profile-citizenid-input").val();
        if (cid) {
            $.post('https://mdt/removeProfileTag', JSON.stringify({
                cid: cid,
                text: $(this).data("info")
            }));
        }
    ...
    $(".reports-search-refresh").click(function () {
        if (canRefreshReports == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://mdt/getAllReports', JSON.stringify({}));
            }, 1500);
        }
    });
    $(".dispatch-comms-refresh").click(function(){
        ...
        setTimeout(() => {
            ...
            canRefreshReports = true
            $.post('https://mdt/refreshDispatchMsgs', JSON.stringify({}));
        }, 1500);
    })
    $(".reports-items").on("click", ".reports-item", function () {
        ...
        let id = $(this).data("id");
        $.post('https://mdt/getReportData', JSON.stringify({
            id: id
        }));
    })
    ...
    $('#reports-gallery-upload-input').keydown(function (e) {
        if (e.keyCode === 13) {
            ...
            if (URL !== "") {
                let randomNum = Math.ceil(Math.random() * 10).toString()
                $('.reports-gallery-inner-container').prepend(`<img src="${URL}" class="reports-img ${randomNum}" onerror="this.src='https://cdn-icons-png.flaticon.com/512/2748/2748558.png'">`);
    ...
    $('#reports-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForReports == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://mdt/searchReports', JSON.stringify({
                    name: name
                }));
                $(".reports-items").empty();
    ...
    $(".manage-reports-title-holder").on("click", ".manage-reports-save", function () {
        ...
        $.post('https://mdt/newReport', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            type: type,
    ...
    $('#missing-search-input').keydown(function (e) {
        if (e.keyCode === 13) {
            ...
            if (name !== "") {
                $.post('https://mdt/searchMissing', JSON.stringify({
                    name: name
                }));
                $(".missing-items").empty();
    ...
    $(".missing-items").on("click", ".missing-item", function () {
        $.post('https://mdt/getMissingData', JSON.stringify({
            id: $(this).data("dbid")
        }));
    });
    ...
    $(".vehicle-information-title-holder").on("click", ".vehicle-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://mdt/saveVehicleInfo', JSON.stringify({
                    dbid: dbid,
                    plate: plate,
                    imageurl: imageurl,
                    notes: notes
    ...
    $(".weapon-information-title-holder").on("click", ".weapon-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://mdt/saveWeaponInfo', JSON.stringify({
                    dbid: dbid,
    ...
    $(".missing-information-title-holder").on("click", ".missing-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://mdt/saveMissingInfo', JSON.stringify({
                    id: dbid,
                    imageurl: imageurl,
                    notes: notes
                }));
    ...
    $(".contextmenu").on("click", ".mark-code-5", function () { 
        ...
        if ( tag.hasClass("red-tag")) {
            ...
            $.post('https://mdt/knownInformation', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".toggle-duty", function () { 
        ...
        if (currentStatus == "10-8") {
            ...
            $.post('https://mdt/toggleDuty', JSON.stringify({
                cid: info,
                status: 0
            }));
    ...
    $(".contextmenu").on("click", ".set-waypoint", function () { 
        let info = $(this).data("info")
        $.post('https://mdt/setWaypointU', JSON.stringify({
            cid: info,
        }));
    })
    ...
    $(".contextmenu").on("click", ".set-waypoint", function () { 
        ...
        $.post('https://mdt/setWaypoint', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-attach", function () { 
        const callId = $(this).data("info")
        $.post('https://mdt/callAttach', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-detach", function () { 
        const callId = $(this).data("info")
        $.post('https://mdt/callDetach', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".remove-call", function () { 
        ...
        $.post('https://mdt/removeCall', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".attached-units", function () { 
        const callId = $(this).data("info")
        $.post('https://mdt/attachedUnits', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $('#respondcalls').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            ...
            e.preventDefault();
            const time = new Date()
            $.post('https://mdt/sendCallResponse', JSON.stringify({
                message: $(this).val(),
                time: time.getTime(),
                callid: callid
            }));
    ...
    $(".contextmenu").on("click", ".respond-call", function () {
        const callId = $(this).data("info")
        $.post('https://mdt/getCallResponses', JSON.stringify({
            callid: callId
        }));
    ...
    $(".contextmenu").on("click", ".call-dispatch-detach", function () { 
        const cid = $(this).data("info")
        $.post('https://mdt/callDispatchDetach', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".Set-Dispatch-Waypoint", function () { 
        const cid = $(this).data("info")
        $.post('https://mdt/setDispatchWaypoint', JSON.stringify({
            callid: $(".dispatch-attached-units-container").attr("id"),
            cid: cid
        }));
    })
    ...
    $(".jail-buttons").on("click", ".jail-submit", function () {
        ...
        if (time.length > 0) {
            ...
            $.post('https://mdt/jailPlayer', JSON.stringify({
                cid: cid,
                time: time
            }));
            $(".jail-inner-container").slideUp(500)
    ...
    $(".callsign-buttons").on("click", ".callsign-submit", function () {
        ...
        if (callsign.length > 2) {
            ...
            $.post('https://mdt/setCallsign', JSON.stringify({
                cid: editingcallsign,
    ...
    $(".active-calls-list").on("click", ".active-calls-item", function (e) {
        ...
        if (callId && draggedElement) {
            $.post('https://mdt/callDragAttach', JSON.stringify({
                callid: callId,
                cid: draggedElement
            }));
            draggedElement = 0
    ...
    function JobColors(sentJob) {
        ...
        if (sentJob) {
            if (sentJob == 'police') {
                ...
                $(".badge-logo").attr('src','https://prod.cloud.rockstargames.com/crews/sc/7874/9340607/publish/emblems/0e2f7e83bac282bc2e46c08e22b1047f978f524c_512.png');
                ...
                $(".badge-logo").attr('src','https://w7.pngwing.com/pngs/160/152/png-transparent-star-of-life-emergency-medical-services-symbol-ambulance-miscellaneous-angle-logo-thumbnail.png');
                ...
                $(".badge-logo").attr('src', 'https://toppng.com/uploads/preview/court-house-courthouse-11562896380a7tvxfgkq7.png');
        ...
        if (e.type == "show") {
            ...
            if (table["gallery"]) {
                $.each(JSON.parse(table["gallery"]), function (index, value) {
                    $('.gallery-inner-container').prepend(`<img src="${value}" class="gallery-img" onerror="this.src='https://cdn-icons-png.flaticon.com/512/2748/2748558.png'">`);
                })
            }
            if ($(".badge-logo").attr('src') == 'https://prod.cloud.rockstargames.com/crews/sc/7874/9340607/publish/emblems/0e2f7e83bac282bc2e46c08e22b1047f978f524c_512.png') {
            ...
            } else  if ($(".badge-logo").attr('src') == 'https://w7.pngwing.com/pngs/160/152/png-transparent-star-of-life-emergency-medical-services-symbol-ambulance-miscellaneous-angle-logo-thumbnail.png') {
                if (table["treatments"]) {
            ...
            if ((BodyDisplay) == "block") {
                ...
                $.post('https://mdt/dispatchNotif', JSON.stringify({
                    data: value,
                }));
            }
            $('.dispatch-items').scrollTop($('.dispatch-items')[0].scrollHeight)
            ...
            $.each(JSON.parse(table["gallery"]), function (index, value) {
                let randomNum = Math.ceil(Math.random() * 10).toString()
                $('.bolo-gallery-inner-container').prepend(`<img src="${value}" class="bolo-img ${randomNum}" onerror="this.src='https://cdn-icons-png.flaticon.com/512/2748/2748558.png'">`);
            })
            ...
            canSearchForProfiles = true
            $(".bolos-items").empty();
            if ($(".badge-logo").attr('src') == 'https://w7.pngwing.com/pngs/160/152/png-transparent-star-of-life-emergency-medical-services-symbol-ambulance-miscellaneous-angle-logo-thumbnail.png') {reportName = "ICU Check-in"}
            $.each(table, function (index, value) {
                if (value.type == "ambulance") {
                    if ($(".badge-logo").attr('src') == 'https://w7.pngwing.com/pngs/160/152/png-transparent-star-of-life-emergency-medical-services-symbol-ambulance-miscellaneous-angle-logo-thumbnail.png') {
                        $('.bolos-items').prepend(
            ...
            let table = e.data
            let image = "https://cdn-icons-png.flaticon.com/512/2748/2748558.png"
            $(".missing-items").empty();
            ...
            $.each(JSON.parse(table["gallery"]), function (index, value) {
                let randomNum = Math.ceil(Math.random() * 10).toString()
                $('.reports-gallery-inner-container').append(`<img src="${value}" class="reports-img ${randomNum}" onerror="this.src='https://cdn-icons-png.flaticon.com/512/2748/2748558.png'">`);
            })
            $.each(JSON.parse(table["officers"]), function (index, value) {
...
function fidgetSpinner(page) {
    ...
    if (page == '.missing-page-container') {
        $.post('https://mdt/getAllMissing', JSON.stringify({}));
    }
    if (page == '.reports-page-container') {
        $.post('https://mdt/getAllReports', JSON.stringify({}));
    }
    if (page == '.stafflogs-page-container') {
        $.post('https://mdt/getAllLogs', JSON.stringify({}));
    }
...
function addTag(tagInput) {
    ...
    $.post('https://mdt/newTag', JSON.stringify({
...
function addWeapon(Input) {
    ...
    $.post('https://mdt/newWeapon', JSON.stringify({
        id: $(".manage-profile-citizenid-input").val(),
        serialnumber: Input
    }));
}
...
function removeImage(url) {
    ...
    $.post('https://mdt/removeGalleryImg', JSON.stringify({
        cid: cid,
        URL: url
    }));
}
